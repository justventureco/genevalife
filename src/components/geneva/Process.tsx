    ...
    >
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        <div className="mx-auto max-w-[720px] text-center">
          <EyebrowLabel className="text-brick">Engagement</EyebrowLabel>
          <h2
          ...
          >
            A simple, <span className="italic text-brick">deliberate</span> process.
          </h2>
        </div>
          ...
          {steps.map((s, i) => (
            <div
              ...
              className={
                ...
                (i !== 0 ? "border-t border-aubergine/15" : "")
              }
            >
              ...
              <div className="md:col-span-10">
                <h3 className="font-display text-[28px] font-medium text-aubergine md:text-[36px]">
                  {s.title}
                </h3>
                <p className="mt-3 max-w-[680px] text-[17px] leading-[1.65] text-aubergine/85 md:text-[18px]">
                  {s.body}
                </p>
              </div>
            </div>
